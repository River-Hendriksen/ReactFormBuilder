    ...
    return conditionallyShowChildren.every(
        ({
            ...
            if (
                ...
                return (
                    conditionValue as CheckBoxArrayObjectValueProps[]
                ).every((condition) => {
                    return (
    ...
    return conditions.every(
        ({ formField, fieldToCompare, conditionValue, comparisonType }) => {
            ...
            return comparison(
                ...
                fieldToCompare
                    ? formData[fieldToCompare]
                    : conditionValueString, //if there is a field value to compare against, compare that, otherwise compare to the current field value
                comparisonType
            );
        }
    );
