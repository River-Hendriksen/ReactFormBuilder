...
export const FormLikert: React.FC<LikertProps> = ({
  ...
  const inputClass =
    ...
    " shrink-0 my-auto h-[1.2] w-[1.2] appearance-none rounded-full border border-slate-500 checked:bg-slate-500  shadow-[inset_0px_0px_0px_4px_rgba(255,255,255,1)]";
